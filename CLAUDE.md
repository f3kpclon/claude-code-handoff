...
### Triggers
Si el contexto adicional contiene `HANDOFF REQUESTED` (inyectado por el hook automático), o el usuario escribe explícitamente `/handoff`, `pausa sesión`, `cierra sesión` o `termina sesión` → invoca `/handoff` ANTES de responder cualquier otra cosa.
